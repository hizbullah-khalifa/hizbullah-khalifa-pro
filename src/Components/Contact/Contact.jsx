...
const Contact = () => {
  ...
  const contactDetails = [
    {
      icon: Mail,
      text: 'hizbullahkhalifaa@gmail.com',
      label: 'Email Contact',
      color: '#6366f1',
      href: 'mailto:hizbullahkhalifaa@gmail.com'
    },
    {
      icon: MapPin,
      text: 'Dir Lower, Kpk Pakistan',
      label: 'Location',
      color: '#a855f7',
      href: 'https://maps.google.com/?q=DirLower+03'
    },
    {
      icon: Phone,
      text: '+92 329 91 90021',
      label: 'Phone Contact',
      color: '#ec4899',
      href: 'tel:+92 329 91 90021'
    }
  ];
  ...
  const initializeAnimations = () => {
    ...
    tl.fromTo(leftSectionRef.current.querySelector('h1'),
      { x: -60, opacity: 0 },
    ...
    // Setup hover animations for contact details
  ...
  const handleSubmit = async (e) => {
    ...
    // Button animation during submit
    buttonTl
      .to(submitButton, {
        scale: 0.95,
      ...
      {[...Array(6)].map((_, i) => (
        <div
          ...
          style={{
            ...
            '--duration': `${3 + i * 0.5}s`,
            '--size': `${8 + i * 4}px`,
            '--color': ['#6366f1', '#a855f7', '#ec4899', '#f59e0b', '#10b981', '#06b6d4'][i],
            '--opacity': 0.1 + (i * 0.05),
            top: `${10 + i * 12}%`,
            left: `${5 + i * 15}%`,
          }}
      ...
      <div className="contact-content">
        ...
        <div className="contact-section">
          ...
          <div className="contact-left" ref={leftSectionRef}>
            ...
            <p>
              Ready to bring your vision to life? I'm here to help you build exceptional 
              digital experiences that make a real impact. Let's discuss your project and 
            ...
            <div className="contact-details" ref={contactDetailsRef}>
              {contactDetails.map((detail, index) => {
                ...
                return (
                  ...
                  >
                    <div className="contact-icon" style={{ '--color': detail.color }}>
                      <Icon size={20} />
                    </div>
