...
const About = () => {
  ...
  const techStack = [
    ...
    { Icon: FaBootstrap, name: "Bootstrap", color: "#7952B3", description: "CSS Framework" },
    ...
    { Icon: FaPhp, name: "PHP", color: "#777BB4", description: "Backend Language" },
    ...
    { Icon: FaGithub, name: "GitHub", color: "#181717", description: "Code Hosting" },
    { Icon: SiPostman, name: "Postman", color: "#FF6C37", description: "API Testing" },
  ];
        ...
        >
          ...
          onMouseLeave={(e) => {
            ...
            <div style={{
              ...
              {techStack.filter(tech => ['React', 'JavaScript', 'HTML5', 'CSS3', 'Bootstrap', 'Tailwind'].includes(tech.name)).map((tech) => (
                <div
                  key={tech.name}
                  style={{
                    display: 'flex',
          ...
          onMouseLeave={(e) => {
            ...
            <div style={{
              ...
              {techStack.filter(tech => ['Node.js', 'PHP', 'MongoDB', 'Express.js', 'SQL', 'Git', 'GitHub', 'Postman'].includes(tech.name)).map((tech) => (
                <div
                  key={tech.name}
                  style={{
                    display: 'flex',
                ...
                >
                  <tech.Icon size={24} color={tech.color} style={tech.name === 'Express.js' || tech.name === 'GitHub' ? {filter: 'invert(1)'} : {}} />
                  <span style={{
                    color: '#ffffff',
                    fontSize: '0.8rem',
                    marginTop: '0.5rem',
