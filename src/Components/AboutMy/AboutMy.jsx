...
import profileImg from "../assets/folder.png";
...
const About = () => {
  ...
  useEffect(() => {
    const preloadAssets = async () => {
      ...
      const videoLoadPromise = new Promise((resolve) => {
        video.oncanplaythrough = () => { setVideoLoaded(true); resolve(); };
        video.onerror = () => { setVideoLoaded(false); resolve(); };
      });
  ...
  const animateElements = useCallback(() => {
    ...
    setTimeout(() => {
      if (profileRef.current) { profileRef.current.style.opacity = "1"; profileRef.current.style.transform = "scale(1)"; }
    }, delay * 3);
    setTimeout(() => {
      if (paraRef.current) { paraRef.current.style.opacity = "1"; paraRef.current.style.transform = "translateY(0)"; }
    }, delay * 4);
  }, [isMobile]);
  ...
  return (
    ...
    >
      ...
      >
        {/* Title */}
        <div className="title-section" ref={titleRef} style={{
          textAlign: "center", marginBottom: isMobile ? "2rem" : "3rem",
        ...
        {/* Profile Image with Orbiting Tech Logos */}
        <div ref={profileRef} style={{
          ...
          <div className="profile-container" style={{
            ...
            {/* Rings */}
            <div className="outer-ring" style={{ position:"absolute", top:"-20px", left:"-20px", right:"-20px", bottom:"-20px", borderRadius:"50%", border:"4px solid transparent", borderTopColor:"#6366f1", borderRightColor:"#a855f7", animation:"rotate 3s linear infinite", zIndex:0 }} />
            <div className="middle-ring" style={{ position:"absolute", top:"-15px", left:"-15px", right:"-15px", bottom:"-15px", borderRadius:"50%", border:"3px solid transparent", borderBottomColor:"#ec4899", borderLeftColor:"#f59e0b", animation:"rotateReverse 4s linear infinite", zIndex:0 }} />
            <div className="rotating-border" style={{ position:"absolute", top:"-10px", left:"-10px", right:"-10px", bottom:"-10px", borderRadius:"50%", background:"linear-gradient(135deg, #6366f1, #a855f7, #ec4899, #f59e0b)", animation:"rotate 5s linear infinite", zIndex:1 }} />
            <div className="pulsing-ring" style={{ position:"absolute", top:"-25px", left:"-25px", right:"-25px", bottom:"-25px", borderRadius:"50%", border:"2px solid rgba(99,102,241,0.4)", animation:"pulse 2s ease-in-out infinite", zIndex:0 }} />
            <div style={{ position:"absolute", top:"-5px", left:"-5px", right:"-5px", bottom:"-5px", borderRadius:"50%", background:"radial-gradient(circle, rgba(99,102,241,0.3) 0%, transparent 70%)", animation:"pulse 3s ease-in-out infinite alternate", zIndex:1 }} />

            {/* ✅ Profile Image using local asset */}
            <div style={{
            ...
            {techStack.map((tech, i) => {
              ...
              return (
                <div key={tech.name} className="tech-logo-orbit" style={{
                  position: "absolute",
                  width: isMobile ? "45px" : "55px", height: isMobile ? "45px" : "55px",
                  top: "50%", left: "50%",
                  ...
                  >
                    <img src={tech.logo} alt={tech.name} style={{
                      width: isMobile ? "28px" : "35px", height: isMobile ? "28px" : "35px",
                      objectFit: "contain",
            ...
            {[...Array(8)].map((_, i) => {
              ...
              return (
                <div key={i} className="floating-particle" style={{
                  ...
                  zIndex: 0, transform: "translate(-50%, -50%)",
                }} />
              );
            })}
            ...
            {!isMobile && [...Array(4)].map((_, i) => {
              ...
              const radius = 160;
              return (
                <div key={`star-${i}`} className="orbiting-star" style={{
        ...
        {/* Description */}
        <div className="description-section" ref={paraRef} style={{
      ...
      <style>{`
        ...
        .profile-container:hover .rotating-border { animation-duration: 2.5s; }
        .profile-container:hover .outer-ring { animation-duration: 1.5s; }
        .profile-container:hover .middle-ring { animation-duration: 2s; }
